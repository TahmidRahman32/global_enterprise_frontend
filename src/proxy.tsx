...
//         // If verification succeeds, extract the role
//         userRole = (verifiedToken as JwtPayload).role;
//      } catch (error) {
//         // Token is invalid (signature mismatch, expired, malformed, etc.)
//         console.error("JWT verification failed:", (error as Error).message);
//         await deleteCookie("accessToken");
//         await deleteCookie("refreshToken");
//         // Redirect to login (or return 401 if it's an API route)
...
//    if (routerOwner === "ADMIN" || routerOwner === "SUPER_ADMIN" || routerOwner === "USER") {
