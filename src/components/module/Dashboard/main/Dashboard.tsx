"user client";
import MainDashboardContent, { StatCard } from "./DashboardContent";
...
import { Menu, X, Home, Printer, FileText, Settings, Users, Package, ChevronDown, TrendingUp, CheckCircle, Clock, PlusCircle } from "lucide-react";
