...
import { DeleteModal } from "./OrderDeleteModal";
...
export default function OrderTable({ orders: apiOrders }: { orders: ApiOrder[] }) {
   ...
   return (
      <div className="">
                     ...
                     <div className="p-5">
                        ...
                        <div className="mt-5 flex items-center justify-between">
                           ...
                           <div className="flex gap-1">
                              ...
                              <button
                                 onClick={() => setDeleteTarget(order)} // ✅ pass the full order object
         ...
         <DeleteModal order={deleteTarget} open={!!deleteTarget} onClose={() => setDeleteTarget(null)} onDeleted={handleDelete} />
      </div>
   );
}
